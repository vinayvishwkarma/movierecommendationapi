...
public class ApiKeyServiceImpl implements ApiKeyService {
    ...
    @Override
    public ApiKeyDTO generateAndStoreApiKey(final String serviceName) {
        ...
        return new ApiKeyDTO(apiKey.getServiceName(), rawApiKey, apiKey.getCreatedAt(), apiKey.getExpiryDate());
    }
    ...
    @Override
    public ApiKeyDTO regenerateApiKey(final String serviceName) {
